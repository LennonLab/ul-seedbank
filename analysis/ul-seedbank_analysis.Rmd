...
nfd.response <- function(OTUs = NULL, OTUs.active = NULL, max.taxa = 10, num.iter = 999, plotit = F, incidence.freq = 0.5){
  ...
  max.taxa <- floor(seq(5, ncol(OTUs.persistent), length.out = max.taxa))
...
active.nfd.response <- nfd.response(OTUs = OTUs.total, OTUs.active = OTUs.active, max.taxa = 5, num.iter = 100)
