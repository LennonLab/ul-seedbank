...
tot.nd <- get.null.distr(comm = OTUs.total.nozero, iters = 999)
act.nd <- get.null.distr(comm = OTUs.active.nozero, iters = 999)
sb.nd <- get.null.distr(comm = OTUs.seedbank.nozero, iters = 999)
