...
ggplot(joint_data, aes(x = abund, y = lambda)) + 
  ...
  ggsave("figures/figS2.pdf", height = 20*1.5, width = 30*1.5) +
  ggsave("figures/figS2.png", height = 20*1.5, width = 30*1.5, dpi = 500)
...
plot_grid(nfdactiveslopesfig, nfdactivefig, ncol = 1, labels = "AUTO") +
  ggsave("figures/figS3.pdf", width = 6, height = 8) +
  ggsave("figures/figS3.png", width = 6, height = 8, dpi = 600)
...
null_dist_toplot_ses %>% 
  ...
  ggsave("figures/figS4.pdf", width = 8, height = 3/4*8) +
  ggsave("figures/figS4.png", width = 8, height = 3/4*8, dpi = 600)
...
cbind.data.frame(env.vars['temp'], decostand(OTUs.active.persistent, method = "total")[,sample(1:ncol(OTUs.active.persistent),25)]) %>% 
  ...
  theme(legend.position = "none")+
  ggsave("figures/figS5.pdf", width = 5*4, height = 5*3) +
  ggsave("figures/figS5.png", width = 5*4, height = 5*3, dpi = 600)
