...
null_dist_toplot %>% 
  ...
  geom_jitter(data = subset(null_dist_toplot, obsim == "Observed"), size = 3, alpha = 0.5) + 
  geom_line(data = subset(null_dist_toplot, obsim == "Observed"), size = 1, alpha = 1, stat = "smooth", span = .5, method = "loess", se = F) +
