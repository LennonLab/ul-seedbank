...
persistent.grs.all %>%   
  ...
  #scale_y_continuous(limits = c(-5, 12)) +
   ggsave("figures/max_growth_date.pdf", bg = "white", width = 8, height = 8*3/4)
