...
saveRDS(null_dist_tot, "analysis/null_dists_reactivations_c0samp.rda")
null_dist_tot <- readRDS("analysis/null_dists_reactivations_c0samp.rda")
# analyze null dist
...
null_calc_meansd <- null_dist_toplot %>% 
  ...
  select(OTU, taxon_mean, taxon_sd, relabund) %>% 
  unique(.)
